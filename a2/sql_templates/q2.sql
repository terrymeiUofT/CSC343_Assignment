...
SELECT fid, airline, EXTRACT(YEAR FROM s_dep) as year, dep_delay, arv_delay, seat_class, price, 0.35*price refund
...
SELECT fid, airline, EXTRACT(YEAR FROM s_dep) as year, dep_delay, arv_delay, seat_class, price, 0.5*price refund
FROM InterFlight_price
